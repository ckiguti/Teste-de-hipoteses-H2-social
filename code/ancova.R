#' ---
#' title: "ANCOVA test for `fss`~`dfs`+`scenario`*`social`"
...
#'
## ---- echo=FALSE-------------------------------------------------------------------------------------------------------------------------------
car::Boxplot(`fss` ~ `scenario`*`social`, data = dat[["fss"]], id = list(n = Inf))
...
#' ### Textual Report
#'
#' After controlling the linearity of covariance "dfs", ANCOVA tests with independent between-subjects variables "scenario" (gamified, non.gamified) and "social" (upper, lower) were performed to determine statistically significant difference on the dependent varibles "fss". For the dependent variable "fss", there was statistically significant effects in the interaction of factors "scenario:social" with F(1,27)=10.525, p=0.003 and ges=0.28 (effect size).
#'
#'
#'
#' Pairwise comparisons using the Estimated Marginal Means (EMMs) were computed to find statistically significant diferences among the groups defined by the independent variables, and with the p-values ajusted by the method "bonferroni". For the dependent variable "fss", the mean in the scenario="gamified" (adj M=3.976 and SD=0.779) was significantly different than the mean in the scenario="non.gamified" (adj M=3.247 and SD=0.346) with p-adj=0.022; the mean in the scenario="gamified" (adj M=3.143 and SD=0.389) was significantly different than the mean in the scenario="non.gamified" (adj M=3.745 and SD=0.63) with p-adj=0.041; the mean in the social="lower" (adj M=3.976 and SD=0.779) was significantly different than the mean in the social="upper" (adj M=3.143 and SD=0.389) with p-adj=0.008.
#'
#'
#'
#' ## Tips and References
